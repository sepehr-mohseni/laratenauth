...
[![Tests](https://img.shields.io/github/actions/workflow/status/sepehr-mohseni/laratenauth/run-tests.yml?branch=master&label=tests&style=flat-square)](https://github.com/sepehr-mohseni/laratenauth/actions/workflows/run-tests.yml)
