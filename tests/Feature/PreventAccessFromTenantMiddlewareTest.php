...
use Sepehr_Mohseni\LaraTenAuth\Middleware\PreventAccessFromTenant;
...
class PreventAccessFromTenantMiddlewareTest extends TestCase
{
    ...
    public function test_passes_when_no_tenant_context(): void
    {
        $middleware = new PreventAccessFromTenant($this->context);

        $request = Request::create('http://example.com/central/settings');
    ...
    public function test_throws_when_tenant_context_exists(): void
    {
